...
<center>
```{r, echo = FALSE, dev=c("jpeg"), fig.alt = "Visualizing risk set composition at each time point"}
...
<center>
```{r, echo = FALSE, out.width="50%", dev=c("jpeg"), fig.alt = "Visualizing risk set composition at each time point - full risk set"}
# ... saving current graphical parameters
op <- par(no.readonly = TRUE)
...
<center>
```{r, echo = FALSE, dev=c("jpeg"), fig.alt = "Visualizing risk set composition at each time point - manual risk set for directed network"}
dyad_occurred <- c(11,4,11,11) 
...
<center>
```{r, echo = FALSE, out.width="50%", dev=c("jpeg"), fig.alt = "Visualizing risk set composition at each time point - manual risk set for undirected network"}
# ... saving current graphical parameters
op <- par(no.readonly = TRUE)
...
```{r, echo=FALSE, out.width="50%", dev=c("jpeg"), fig.alt = "Plot showing manual risk set modifications from the omit_dyad argument"}
# ... saving current graphical parameters
op <- par(no.readonly = TRUE)
...
<center>
```{r, echo=FALSE, out.width="50%", dev=c("jpeg"), fig.alt = "Plot showing manual risk set before processing"}
# ... saving current graphical parameters
op <- par(no.readonly = TRUE)
...
<center>
```{r, echo=FALSE, out.width="50%", dev=c("jpeg"), fig.alt = "Plot showing manual risk set while processing"}
# ... saving current graphical parameters
op <- par(no.readonly = TRUE)
...
<center>
```{r, echo=FALSE, out.width="50%", dev=c("jpeg"), fig.alt = "Plot showing manual risk set modifications after processing"}
# ... saving current graphical parameters
op <- par(no.readonly = TRUE)
