...
The internal routines will process the structure of the input event sequence into a new one, providing also objects that will be used by the packages in [<tt>remverse</tt>](https://github.com/TilburgNetworkGroup/remverse).
...
The plots above slightly vary for the case of undirected networks:
