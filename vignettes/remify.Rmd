...
If `omit_dyad` is supplied to the processing function, `getRiskset(reh)` returns the processed dynamic risk set matrix (or the two dynamic risk sets if actor-oriented modeling) that are explained in the 'Output' section under the section about `omit_dyad`.
